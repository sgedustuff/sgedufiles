...
public class BaseTestClass {
	...
	//make those members as static.
	//whose last value is required  in another classes
	//who are inherting this class.
	...
	public void select(String key, String val) {
		...
		try {
		  ...
		  log.info(val + " is selected from dropdown " + key );	
		} catch (Throwable t) {
			log.error("Error while selecting " + val + " : " + key + " error is : " + t.getMessage());			
		}
	}
	...
	public Alert isAlertPresent(){
		...
		try
		{
			...
			log.info("Alert is found");
		}catch(Exception ex)
		{
			log.error("Error while finding an Alert Box:  error is : " + ex.getMessage());
		}		
		return al;
	}
